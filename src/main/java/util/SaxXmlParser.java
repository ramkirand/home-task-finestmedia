...
public class SaxXmlParser {
	...
	@TrackExecutionTime
	public static EnergyReport parser(String xmlString) throws ParserConfigurationException, SAXException, IOException {
	...
	private static void initialSetUp(String xmlString) throws ParserConfigurationException, SAXException, IOException {
