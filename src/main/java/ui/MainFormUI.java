...
public class MainFormUI extends VerticalLayout {
  ...
  private void validateInputDate(String date, Div value,
    ...
    submitbtn.addClickListener(e -> {
      ...
      if (Double.parseDouble(inputTextField.getValue()) < 0
        ...
        if (inputDatePicker.getValue() != null && inputTextField.getValue() != null) {
          List<ConsumptionData> fetchByPrice = ifinestService.findByMeasurmentPrice(
              inputDatePicker.getValue().toString(), inputTextField.getValue());
